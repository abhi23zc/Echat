...
function Login(props) {
  const { login, setlogin, name, chatid, setname, setchatid } = props.props;
        ...
        <div class="min-h-screen flex flex-col items-center justify-center">
          <div class="grid md:grid-cols-2 items-center gap-4 max-w-6xl w-full p-4 m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
            <div class="md:max-w-md w-full sm:px-6 py-4">
              <form>
                <div class="mb-12">
                  <h3 class="text-3xl font-extrabold">ChatHub</h3>
                  <p class="text-sm mt-4 ">Login in your chatroom </p>
                </div>
                <div>
                ...
                <div class="mt-8">
                  <label class="text-xs block mb-2">ChatRoom Id</label>
                  <div class="relative flex items-center">
                    <input
                      value={chatid}
